...
aiRoundState:{inventoryPhase:1,lastInventorySoftFallbackUsed:false,inventoryIdleTurns:0,inventorySoftFallbackCooldown:5},
...
assert(used===true,'phase1 should allow immediate buff use without idle-turn unlock');
