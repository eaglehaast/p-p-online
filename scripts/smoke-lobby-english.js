...
// «Комната создаётся…» до кнопки «Войти». Выглядит это так: человек открывает английскую
// игру, зовёт друга — и упирается в текст на языке, которого не знает. Причём упирается
// ровно там, где без второго игрока дальше хода нет.
//
